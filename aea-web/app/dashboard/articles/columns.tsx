...
import { deleteProduct } from "@/server/actions/delete-article";
...
import { ProductVariant } from "./article-type";
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        <DropdownMenuItem className="dark:focus:bg-primary focus:bg-primary/50 cursor-pointer">
          <Link href={`/dashboard/add-article?id=${product.id}`}>
            Edit Article
          </Link>
        </DropdownMenuItem>
        <DropdownMenuItem
  ...
  cell: ({ row }) => {
    ...
    return (
      <div className="flex gap-2">
        ...
        {/* Only show the "+" button if no variants exist */}
        {!hasVariants && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
