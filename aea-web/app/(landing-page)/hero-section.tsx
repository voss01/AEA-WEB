  ...
  return (
    <div className="flex flex-col md:items-center ">
            ...
            <Link href={tab.href}>
             ...
             `}
              ...
              >
                ...
                <motion.div className="px-4 relative z-10 mt-4">
      ...
      <div className="w-full py-2 mt-4">
        {" "}
        {/* Reduced padding to bring it closer to image */}
        ...
        <div className="overflow-hidden">
          ...
          >
            <span>
              <p>
                / let&rsquo;s / let&rsquo;s connect! Join us -- / let&rsquo;s
                connect! Join us -- / let&rsquo;s connect! Join us -- /
                let&rsquo;s connect! Join us -- / let&rsquo;s connect! Join us
                -- / let&rsquo;s connect! Join us -- / connect! Join us -- /
                let&rsquo;s connect! Join us -- / let&rsquo;s connect! Join us
                -- / let&rsquo;s connect! Join us -- / let&rsquo;s connect! Join
                us -- / let&rsquo;s connect! Join us -- / let&rsquo;s connect!
                Join us -- / let&rsquo;s connect! Join us -- / let&rsquo;s
                connect! Join us -- / let&rsquo;s connect! Join us -- /
                let&rsquo;s connect! Join us -- / let&rsquo;s connect! Join us
                --
              </p>
